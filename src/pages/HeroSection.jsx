      ...
      <div className="container max-w-2xl mx-auto relative z-10">
        ...
        <div className="border-2 border-muted-foreground/40 rounded-lg text-center bg-background/80 backdrop-blur-md shadow-2xl shadow-primary/5 hover:shadow-primary/10 transition-shadow duration-500">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-12">
              <a href="/blog" className="cosmic-button hover:bg-primary/90 text-lg px-8 py-3 hover:scale-110 hover:shadow-xl transition-transform duration-200 hover:underline">
                blog posts
              </a>
            </div>
            ...
            <div className="border-t-2 border-muted-foreground/40 pt-6 mt-6 text-sm md:text-base text-foreground/90">
              ...
              <div className="grid grid-cols-1 gap-3 text-center md:hidden">
                <div className="grid grid-cols-[1fr_auto_1fr] items-center">
                  <a href="/about" className="justify-self-end transition-colors duration-300 px-4 hover:text-primary hover:underline rounded-md font-medium">
                    about
                  </a>
                  <span className="text-muted-foreground/40 justify-self-center">•</span>
                  <a href="/blog" className="justify-self-start transition-colors duration-300 px-4 hover:text-primary hover:underline rounded-md font-medium">
                    blog
                  </a>
                </div>
                <div className="grid grid-cols-[1fr_auto_1fr] items-center">
                  <a href="/projects" className="justify-self-end transition-colors duration-300 px-4 hover:text-primary hover:underline rounded-md font-medium">
                    projects
                  </a>
                  <span className="text-muted-foreground/40 justify-self-center">•</span>
                  <a href="/contact" className="justify-self-start transition-colors duration-300 px-4 hover:text-primary hover:underline rounded-md font-medium">
                    contact
                  </a>
                </div>
              </div>
              ...
              <div className="hidden md:flex flex-wrap justify-center gap-3 md:gap-4">
                <a href="/about" className="hover:text-primary transition-colors duration-300 px-2 hover:bg-muted/30 rounded-md hover:underline font-medium">about</a>
                <span className="text-muted-foreground/40">•</span>
                <a href="/blog" className="hover:text-primary transition-colors duration-300 px-2 hover:bg-muted/30 rounded-md hover:underline font-medium">blog</a>
                <span className="text-muted-foreground/40">•</span>
                <a href="/projects" className="hover:text-primary transition-colors duration-300 px-2 hover:bg-muted/30 rounded-md hover:underline font-medium">projects</a>
                <span className="text-muted-foreground/40">•</span>
                <a href="/contact" className="hover:text-primary transition-colors duration-300 px-2 hover:bg-muted/30 rounded-md hover:underline font-medium">contact</a>
              </div>
            </div>
